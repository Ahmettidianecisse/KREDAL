...
const roles = [
  "scoring borrowers instantly",
  "detecting fraud in real-time",
  "powering African fintechs",
  "unlocking financial inclusion",
  "forging credit intelligence",
]
          ...
          <div className="space-y-8 sm:space-y-10">
            <div className="space-y-3 animate-fade-in-up">
              <p className="font-mono text-xs uppercase tracking-[0.25em] sm:tracking-[0.35em] text-primary">
                Kredal — Financial Intelligence for Africa
              </p>
            ...
            <p className="max-w-lg text-base sm:text-lg leading-relaxed text-muted-foreground animate-fade-in-up stagger-2">
              Welcome to Kredal — the API platform built for African fintechs. Score any borrower in{" "}
              <span className="text-foreground font-medium">milliseconds</span> using alternative data. Here, credit
              decisions are forged, tested, and refined. Not a dashboard. An intelligence engine.
            </p>
